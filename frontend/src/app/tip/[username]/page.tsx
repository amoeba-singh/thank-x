...
export default function ProfilePage() {
  ...
  const handleTip = async () => {
    ...
    if (parseFloat(balance) < parseFloat(tipAmount)) {
      setError(
        <>
          Insufficient balance. You have {balance} XION available. Please credit the XION token to your wallet from{' '}
          <a href="https://faucet.xion.burnt.com" target="_blank" rel="noopener noreferrer" style={{ color: '#007bff', textDecoration: 'underline' }}>
